 ...
 */
class Corresponsalia extends \Frontend\CorresponsaliaBundle\Entity\Corresponsalia implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setTipocorresponsalia($tipocorresponsalia);
    }
