 ...
 */
class Periodorendicion extends \Frontend\CorresponsaliaBundle\Entity\Periodorendicion implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'anio', 'mes', 'observacion', 'estatus', 'corresponsalia', 'tipogasto', 'responsable');
    }
