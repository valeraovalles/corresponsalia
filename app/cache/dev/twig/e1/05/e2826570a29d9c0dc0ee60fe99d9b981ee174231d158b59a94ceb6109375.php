...
";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["entity"]) {
            ...
            if ($this->env->getExtension('security')->isGranted("ROLE_RENDICION_CORRESPONSALIA")) {
                ...
                echo "                    
                            ";
                // line 59
                if ((($this->getAttribute($this->getContext($context, "entity"), "estatus") == 1) || ($this->getAttribute($this->getContext($context, "entity"), "estatus") == 3))) {
                    // line 60
                    echo "                            <a href=\"";
            ...
            if ($this->env->getExtension('security')->isGranted("ROLE_RENDICION_ADMIN")) {
                ...
                if (($this->getAttribute($this->getContext($context, "entity"), "estatus") != 4)) {
                    ...
                    echo "                                <b>CULMINADO</b> | 
                                <a href=\"";
                    // line 75
                    echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("reporte_excelrendicion", array("idperiodo" => $this->getAttribute($this->getContext($context, "entity"), "id"))), "html", null, true);
    ...
    {
        return array (  234 => 91,  227 => 88,  225 => 87,  219 => 83,  209 => 78,  206 => 77,  199 => 75,  196 => 74,  191 => 72,  187 => 71,  182 => 70,  179 => 69,  177 => 68,  174 => 67,  170 => 65,  165 => 62,  159 => 60,  157 => 59,  154 => 58,  152 => 57,  146 => 53,  142 => 51,  138 => 49,  134 => 47,  130 => 45,  128 => 44,  119 => 42,  115 => 41,  111 => 40,  107 => 39,  103 => 38,  97 => 37,  94 => 36,  90 => 35,  72 => 20,  69 => 19,  63 => 14,  53 => 12,  51 => 11,  48 => 10,  45 => 9,  40 => 6,  37 => 5,  31 => 3,);
    }
}
