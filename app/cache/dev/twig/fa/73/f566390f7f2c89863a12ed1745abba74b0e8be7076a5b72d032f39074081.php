...
class __TwigTemplate_fa73f566390f7f2c89863a12ed1745abba74b0e8be7076a5b72d032f39074081 extends Twig_Template
{
    ...
    <li>
        <a href=\"";
        // line 26
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("cambio_edit", array("id" => $this->getAttribute($this->getContext($context, "entity"), "id"))), "html", null, true);
        echo "\">
            Edit
        </a>
    </li>
