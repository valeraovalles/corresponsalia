...
class __TwigTemplate_efb76d45e96ce04ca448824975177a2c2a30b56ac4aa9added46844788399c9f extends Twig_Template
{
    ...
    {
        // line 3
        $context["__internal_502a674b30c2f4313e2b937ec8d9849c4c12edc8891225d5516b238562f55a98"] = $this;
        // line 5
...
";
    ...
    ";
        // line 80
        echo $context["__internal_502a674b30c2f4313e2b937ec8d9849c4c12edc8891225d5516b238562f55a98"]->getdisplay_timeline(("timeline_" . $this->getContext($context, "token")), $this->getAttribute($this->getContext($context, "collector"), "events"), $this->getContext($context, "colors"));
        echo "
    ...
    ";
        ...
        if (twig_length_filter($this->env, $this->getAttribute($this->getContext($context, "profile"), "children"))) {
            ...
            ";
                // line 90
                echo $context["__internal_502a674b30c2f4313e2b937ec8d9849c4c12edc8891225d5516b238562f55a98"]->getdisplay_timeline(("timeline_" . $this->getAttribute($this->getContext($context, "child"), "token")), $this->getContext($context, "events"), $this->getContext($context, "colors"));
                echo "
        ";
            }
...
";
        // line 406
        echo $context["__internal_502a674b30c2f4313e2b937ec8d9849c4c12edc8891225d5516b238562f55a98"]->getdump_request_data($this->getContext($context, "token"), $this->getContext($context, "profile"), $this->getAttribute($this->getContext($context, "collector"), "events"), $this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "collector"), "events"), "__section__"), "origin"));
        echo "
...
";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["child"]) {
                // line 411
                echo $context["__internal_502a674b30c2f4313e2b937ec8d9849c4c12edc8891225d5516b238562f55a98"]->getdump_request_data($this->getAttribute($this->getContext($context, "child"), "token"), $this->getContext($context, "child"), $this->getAttribute($this->getAttribute($this->getContext($context, "child"), "getcollector", array(0 => "time"), "method"), "events"), $this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "collector"), "events"), "__section__"), "origin"));
...
";
    ...
    public function getdump_request_data($_token = null, $_profile = null, $_events = null, $_origin = null)
    {
        ...
        try {
            // line 451
            $context["__internal_bbaa14231ef0570be2b80b876383d6f56c5acacba5aae35af0316f8b7e681b46"] = $this;
            // line 452
            echo "                {
                    \"id\": \"";
            // line 453
...
";
            // line 456
            echo $context["__internal_bbaa14231ef0570be2b80b876383d6f56c5acacba5aae35af0316f8b7e681b46"]->getdump_events($this->getContext($context, "events"));
            echo "
                    ]
                }
";
