...
";
    ...
    <script type=\"text/javascript\">
      function initialize() {
        ...
        $context['_seq'] = twig_ensure_traversable($this->getContext($context, "cor"));
        $context['loop'] = array(
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["corpa"]) {
            ...
            echo "                <table>
                    <tr>
                        ...
                        <td>";
            // line 44
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "corpa"), "nombre"), "html", null, true);
            echo "</td>
                    </tr>
                </table>
            ";
            ...
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "corpa"), "latitud"), "html", null, true);
            echo ", ";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "corpa"), "longitud"), "html", null, true);
            echo "),title:\"";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "corpa"), "pais"), "html", null, true);
            echo "\", icon:image});
