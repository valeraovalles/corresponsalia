...
class __TwigTemplate_b0bd315dee6c9ea9600e558ee5a9b7a10efb1913d175f0e17071003ad3db65d2 extends Twig_Template
{
    ...
    <table id=\"tablalista\" style=\"width: 97%;\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["entity"]) {
            ...
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("tipocorresponsalia_show", array("id" => $this->getAttribute($_entity_, "id"))), "html", null, true);
            echo "\">";
            if (isset($context["entity"])) { $_entity_ = $context["entity"]; } else { $_entity_ = null; }
            ...
            // line 20
            if (isset($context["entity"])) { $_entity_ = $context["entity"]; } else { $_entity_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_entity_, "descripcion"), "html", null, true);
            echo "</td>
                <td>
                    <a href=\"";
            // line 22
            ...
            // line 24
            if (isset($context["entity"])) { $_entity_ = $context["entity"]; } else { $_entity_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("tipocorresponsalia_edit", array("id" => $this->getAttribute($_entity_, "id"))), "html", null, true);
    ...
    {
        return array (  97 => 32,  92 => 29,  80 => 24,  74 => 22,  68 => 20,  60 => 19,  57 => 18,  52 => 17,  38 => 6,  35 => 5,  29 => 3,);
    }
}
