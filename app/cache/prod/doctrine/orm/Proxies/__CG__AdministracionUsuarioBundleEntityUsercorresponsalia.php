 ...
 */
class Usercorresponsalia extends \Administracion\UsuarioBundle\Entity\Usercorresponsalia implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'usuario', 'corresponsalia');
    }
