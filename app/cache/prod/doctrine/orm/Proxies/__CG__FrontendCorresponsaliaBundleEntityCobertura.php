 ...
 */
class Cobertura extends \Frontend\CorresponsaliaBundle\Entity\Cobertura implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'descripcion', 'fechaproceso', 'responsable', 'periodorendicion');
    }
