...
class htmlreporte
{
  ...
  public function excelrendicion($periodo,$ef,$c,$lr,$parametros)
  {
		...
		$html .=" 
                    <table border=1 style='width:500px'>
                        <tr>
                            ...
                            <th colspan=2 style='background-color:#cacaca;text-align:left;'>1. N° Relación: </th>
                            <td colspan=4></td>
                        </tr>
                        <tr>
                            <th colspan=2 style='background-color:#cacaca;text-align:left;'>2. Fecha: </th>
                            <td colspan=4></td>
                        </tr>
                        ...
                        <tr>
                            <th colspan=13  style='background-color:#cacaca;' align='center'>3. TIPO DE GASTO</th>
                        </tr>
                        <tr>
                            <td colspan=13>".$tg."</td>
                        </tr>
                        ...
                        <tr>
                            <th colspan=13  style='background-color:#cacaca;' align='center'>4. CORRESPONSALÍA / 5. PERÍODO</th>
                        </tr>
                        <tr>
                            <th colspan=6  style='background-color:#dddddd;' align='center'>NOMBRE</th>
                        ...
                        <tr>
                            <td colspan=6>".$periodo->getCorresponsalia()->getNombre()."</td>
		...
		";
                ...
                $html .="
                        <tr>
                            <th colspan='13' style='background-color:#cacaca;' align='center'>ESTADO SITUACIÓN DEL FONDO ENVIADO</th>
                        </tr>
                        <tr>
                ...
                $html .="
                        <tr>
                            <th colspan='13'  style='background-color:#cacaca;' align='center'>10. RELACIÓN DE GASTO</th>
                        </tr>
                        <tr>
                            ...
                            <th style='background-color:#dddddd;width:50px;' align='center'>15. Observación</th>
                            <th style='background-color:#dddddd;' align='center'>16. Razón</th>
                            <th style='background-color:#dddddd;' align='center'>17. I. Fiscal</th>
                            <th style='background-color:#dddddd;' align='center'>18. Nro Factura</th>
                            <th style='background-color:#dddddd;' align='center'>19. Moneda</th>
                            <th style='background-color:#dddddd;' align='center'>20. Tasa</th>
                            <th style='background-color:#dddddd;' align='center'>21. Monto MN.</th>
                            <th style='background-color:#dddddd;' align='center'>22. Dólares.</th>
                        </tr>
                        ".$listaren."
                        <tr>
                ...
                $html .="
                       <tr>
                           <td colspan=4  style='background-color:#cacaca;' align='center'><b>23. ELABORADO POR:</b></td>
                           <td colspan=3  style='background-color:#cacaca;' align='center'><b>24. N° DE IDENTIFICACIÓN</b></td>
                           <td colspan=6  style='background-color:#cacaca;' align='center'><b>26. N° JEFE DE SUCURSAL O CORRESPONSALÍA</b></td>
                       </tr>
                       <tr>
                           <td colspan=4 align='center'>".strtoupper($lr[0]->getResponsable()->getPrimerNombre()." ".$lr[0]->getResponsable()->getPrimerApellido())."</td>
                           <td colspan=3 align='center'> </td>
                           <td colspan=3 align='center'>Apellidos y Nombres: </td>
                           <td colspan=3 align='center'>Nro Identificación: </td>
                       </tr>
                       <tr>
                           <td colspan=7  style='background-color:#cacaca;' align='center'><b>25. FIRMA</b></td>
                           <td colspan=6  style='background-color:#cacaca;' align='center'><b>27. FIRMA</b></td>
                       </tr>
                       <tr>
                           <td colspan=7> </td>
                           <td colspan=6> </td>
                       ...
                       <tr>
                            <th colspan='4'><b>28. ANALISTA ENCARGADO(A):</b> </th>
                            <td colspan='3' align='center'>".strtoupper($periodo->getCorresponsalia()->getAnalistaencargado())."</td>
                            <th colspan='3'><b>29. FIRMA:</b> </th>
                            <td colspan='3'></td>
                       </tr>
                       <tr>
                           <td colspan=7  style='background-color:#cacaca;' align='center'><b>CONFORMADO POR:</b></td>
                           <td colspan=6  style='background-color:#cacaca;' align='center'><b>VERIFICADO POR:</b></td>
                       </tr>
                           <td colspan='4'  style='background-color:#dddddd;' align='center'><b>30. UNIDAD DE ADMINISTRACIÓN DE CORRESPONSALÍAS</b></td>
                           <td colspan='3'  style='background-color:#dddddd;' align='center'><b>32. ASIGNACIONES</b></td>
                           <td colspan='3' style='background-color:#dddddd;' align='center'><b>34. DIR. GENERAL DE INFORMACIÓN</b></td>
                           <td colspan='3'  style='background-color:#dddddd;' align='center'><b>36. DIR. DE ADMIN. Y FINANZAS</b></td>
                       </tr>
                       </tr>
                           <td colspan='4' align='center'>".$parametros['unidadapoyologistico']."</td>
                           <td colspan='3' align='center'>".$parametros['asignaciones']."</td>
                           <td colspan='3' align='center'>".$parametros['dirgeneralinformacion']."</td>
                           <td colspan='3' align='center'> </td>
                       </tr>
                       </tr>
                           <td colspan='4' align='center'><b>31. FIRMA</b></td>
                           <td colspan='3' align='center'><b>33. FIRMA</b></td>
                           <td colspan='3' align='center'><b>35. FIRMA</b></td>
                           <td colspan='3' align='center'><b>37. FIRMA</b></td>
                       </tr>
                       </tr>
                           <td colspan='4'> </td>
                           <td colspan='3'> </td>
