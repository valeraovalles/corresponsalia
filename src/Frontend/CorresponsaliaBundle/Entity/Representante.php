 ...
 * Representante
 *
 * @ORM\Table(name="consultoria.representante")
 * @ORM\Entity
 */
class Representante
{
     ...
     * @ORM\SequenceGenerator(sequenceName="consultoria.representante_id_seq", allocationSize=1, initialValue=1)
     */
    private $id;   
     ...
     * })
     * @Assert\NotBlank(message="Debe seleccionar una Contrato.")
     */
    private $contratoId;
     ...
     * })
     * @Assert\NotBlank(message="Debe seleccionar una Personal.")
     */
    private $personalId;
     ...
     * Set contratoId
     *
     * @param \Frontend\CorresponsaliaBundle\Entity\Contrato $contratoId
     * @return Personal
     */
    public function setContratoId(\Frontend\CorresponsaliaBundle\Entity\Contrato $contratoId = null)
    {
     ...
     * Get contratoId
     *
     * @return \Frontend\CorresponsaliaBundle\Entity\Contrato 
     */
     ...
     * Set personalId
     *
     * @param \Frontend\CorresponsaliaBundle\Entity\Personal $personalId
     * @return Personal
     */
    public function setPersonalId(\Frontend\CorresponsaliaBundle\Entity\Personal $personalId = null)
    {
     ...
     * Get personalId
     *
     * @return \Frontend\CorresponsaliaBundle\Entity\Personal 
     */
