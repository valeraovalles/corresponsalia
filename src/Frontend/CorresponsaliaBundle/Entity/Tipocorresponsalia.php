 ...
 * Tipocorresponsalia
 *
 * @ORM\Table(name="rendicion.tipocorresponsalia")
 * @ORM\Entity
 */
class Tipocorresponsalia
{
    /**
     * @var integer
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="rendicion.tipocorresponsalia_id_seq", allocationSize=1, initialValue=1)
     */
    private $id;
